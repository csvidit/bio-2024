...
const ListLink = (props: {
  ...
  return (
    <Link
      ...
      tabIndex={0}
      href={props.href}
      className="group p-4 col-span-4 flex flex-row justify-between items-center bg-gray-50 rounded-lg transition-all  duration-200  ease-in-out  hover:bg-gray-950 hover:scale-[101%] hover:ring hover:ring-gray-500 hover:shadow-lg hover:shadow-gray-500 focus:ring focus:ring-gray-500 focus:shadow-lg focus:shadow-gray-500"
    >
